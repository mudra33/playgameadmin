...
const EditManager = (props) => {
    ...
    const [setSelectedStoreKey] = React.useState({ text: '', key: '' });
    ...
    React.useEffect(() => {
        ...
        setSelectedStore(
            props.storeManager.data && props.storeManager.data.StoreNames[0]
                ? {
                      text: props.storeManager.data.StoreNames[0].StoreName,
                      key: props.storeManager.data.StoreNames[0].StoreKey,
                  }
                : ''
        );
        setSelectedStoreKey(
            props.storeManager.data && props.storeManager.data.StoreNames[0]
                ? {
                      text: props.storeManager.data.StoreNames[0].StoreKey,
                      key: props.storeManager.data.StoreNames[0].StoreKey,
                  }
                : ''
        );
    ...
    return (
        <Layout title="View Manager">
            <PageHeader
                title="Managers"
                button={{ text: 'Add new Manager', link: '/admin/manager/add' }}
                breadcrumb={[
...
export async function getServerSideProps(context) {
    ...
    return { props: { storeManager, token, store: store.data } };
}
